...
export class TvetSchoolInfrastructureService {
  constructor(
      ...
      return {
        [year]: {
          "Main": {
            ...
            "Temporary": (await this.mssqldbDataSource.execute(
              `SELECT COUNT(*) AS TotalCount
              FROM [${dbYear}].[dbo].[TEACHER]
              INNER JOIN [${dbYear}].[dbo].[TEACHER_DATA]
              ON [${dbYear}].[dbo].[TEACHER].[ID_TEACHER]=[${dbYear}].[dbo].[TEACHER_DATA].[ID_TEACHER]
          ...
          "LevelTwo": await Promise.all((await this.mssqldbDataSource.execute(
            ...
            return {
              ...
              "Workshop": (await this.mssqldbDataSource.execute(
                `SELECT COUNT(*) AS TotalCount
                FROM [${dbYear}].[dbo].[TEACHER]
                INNER JOIN [${dbYear}].[dbo].[TEACHER_DATA]
                ON [${dbYear}].[dbo].[TEACHER].[ID_TEACHER]=[${dbYear}].[dbo].[TEACHER_DATA].[ID_TEACHER]
              ...
              "Computers": (await this.mssqldbDataSource.execute(
                `SELECT COUNT(*) AS TotalCount
                FROM [${dbYear}].[dbo].[TEACHER]
                INNER JOIN [${dbYear}].[dbo].[TEACHER_DATA]
                ON [${dbYear}].[dbo].[TEACHER].[ID_TEACHER]=[${dbYear}].[dbo].[TEACHER_DATA].[ID_TEACHER]
