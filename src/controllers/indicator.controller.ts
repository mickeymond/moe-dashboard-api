...
import {TvetEnrolmentSchoolLevelService, TvetInstitutionsService, TvetStudentAgeGroupingService, TvetTeacherStatusService} from '../services';
...
export class IndicatorController {
  constructor(
    ...
    @service(TvetTeacherStatusService)
    private tvetTeacherStatusService: TvetTeacherStatusService
  ) { }
